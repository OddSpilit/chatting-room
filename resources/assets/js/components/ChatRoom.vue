<template>
    <div class="container">
        <a href="?room_id=1" class="btn btn-danger">聊天室</a>
        <hr class="divider">
        ...
        <form @submit.prevent="onSubmit">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" rows="3" id="content" v-model="content" @keyup.enter="onSubmit"></textarea>
            </div>
        ...
        created: function () {
            ws.onmessage = (e) => {
                ...
                switch (type) {
                    ...
                    case 'logout':
                        axios.post('/del', {client_id: data.client_id})
                        break;
                    case "after":
                        this.messages.push(data.who)
                        break;
